...
__all__ = ['MixSoftmaxCrossEntropyLoss', 'MixSoftmaxCrossEntropyOHEMLoss',
           'EncNetLoss', 'ICNetLoss', 'get_segmentation_loss', 'TanimotoLoss']
...
#     criterion = MixSoftmaxCrossEntropyLoss(aux=True, aux_weight=[0.1,1,1,1], ignore_index=-1)
#     # criterion = LovaszSoftmax()
#
#     test_output = [torch.randn(10,3,512,768)]
#     test_target = torch.randn(10,512,768)
#     test_target = torch.where(test_target<0.5, torch.full_like(test_target, 0), torch.full_like(test_target, 1)).long()
#     # print(test_output.shape)
#     print(test_target.shape)
#     print(test_output[0].shape, test_target[0].shape)
