...
class VaiSegmentation(SegmentationDataset):
    """
    Parameters
    ----------
    root : string
    ...
    def __init__(self, root='/home/caoyiwen/data/', split='train', **kwargs):
        ...
        with open(_split_f, 'r') as lines:
            for line in lines:
                _images = self.root+'/images/'+line.rstrip('\n')
                # print(_images)
...
if __name__ == '__main__':
    dataset = VaiSegmentation(split='train')
